...
/// <summary>
/// Set of options controlling generation and appearance of MCGS analysis graphs.
/// </summary>
public record AnalysisGraphOptions
{
  ...
  /// the fraction of time spent cumulatively on reference engine evaluations
  /// compared to time spent on main search.
  /// </summary>
