...
/* This file largely taken from the BitHelpers.cs class of the Microsoft.Toolkit.HighPerformance package
   under the MIT license via the .NET foundation license.
*/
