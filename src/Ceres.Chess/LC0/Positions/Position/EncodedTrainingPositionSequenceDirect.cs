...
namespace Ceres.Chess.EncodedPositions
{
  ...
  /// </summary>
  public class EncodedTrainingPositionSequenceDirect : EncodedTrainingPositionSequenceBase
  {
    EncodedTrainingPosition[] positions;

    public EncodedTrainingPositionSequenceDirect(EncodedTrainingPosition[] positions)
    {
    ...
    public override EncodedPolicyVector PolicyAtIndex(int index) => positions[index].Policies;
