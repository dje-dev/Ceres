...
namespace Ceres.Chess.NNEvaluators.Defs
{
  ...
  public class NNEvaluatorDef
  {
    ...
    /// </summary>
    public readonly (NNEvaluatorNetDef Net, float WeightValue, float WeightPolicy, float WeightM, float WeightU)[] Nets;
    ...
    {
      Nets = new (NNEvaluatorNetDef, float, float, float, float)[] { (netDef, 1, 1, 1, 1) };
    ...
    public NNEvaluatorDef(IEnumerable<(NNEvaluatorDeviceDef, float)> devices, 
                          ...
                          string sharedName, 
                          params (NNEvaluatorNetDef net, float weightValue, float weightPolicy, float weightM, float uncertainty)[] nets)
    {
                          ...
                          NNDeviceType deviceType = NNDeviceType.GPU, int deviceIndex = 0, string sharedName = null)
    {
      ...
      Nets = new (NNEvaluatorNetDef net, float weightValue, float weightPolicy, float weightM, float uncertainty)[] { (new NNEvaluatorNetDef(networkID, netType, NNEvaluatorPrecision.FP16), 1.0f, 1.0f, 1.0f, 1.0f) };
      DeviceCombo = NNEvaluatorDeviceComboType.Single;
      SharedName = sharedName;
    }
    ...
    public NNEvaluatorDef(NNEvaluatorNetDef net, NNEvaluatorDeviceComboType deviceCombo, string sharedName, params NNEvaluatorDeviceDef[] devices)
    {
      ...
      Nets = new (NNEvaluatorNetDef net, float weightValue, float weightPolicy, float weightM, float uncertainty)[] { (net, 1.0f, 1.0f, 1.0f, 1.0f) };
      DeviceCombo = deviceCombo;
      SharedName = sharedName;
    }
    ...
    public NNEvaluatorDef(NNEvaluatorNetComboType netCombo, NNEvaluatorDeviceDef device, string sharedName, params (NNEvaluatorNetDef netDef, float weightValue, float weightPolicy, float weightM, float uncertainty)[] netDefs)
    {
      NetCombo = netCombo;
      Nets = netDefs;
    ...
    public NNEvaluatorDef(NNEvaluatorNetComboType netCombo, IEnumerable<(NNEvaluatorNetDef, float, float, float, float)> nets, 
