...
#region Helpers
    ...
    public BestMoveInfo BestMoveInfo(bool updateStatistics, MGMove forcedMove = default)
    {
      return new ManagerChooseBestMove(this, updateStatistics, Context.ParamsSearch.MLHBonusFactor, forcedMove).BestMoveCalc;
    }
